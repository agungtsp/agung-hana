          ...
          <div className="couple-wrap">
            <div className="couple-half">
              ...
              <div className="desc-groom">
                <h3 className="main-font">Agung Trilaksono Suwarto Putra, S.T.</h3>
                <p className="parent-name parent-name__top">
                  Putra Bapak Suwarto <br />& Ibu Mahyuli
                </p>
              </div>
            </div>
            ...
            <div className="couple-half">
              ...
              <div className="desc-bride">
                <h3 className="main-font">Siti Hasuna, S.Kom.</h3>
                <p className="parent-name">
                  Putri Bapak H. A. Kosasih <br />& Ibu Uliyah
                </p>
              </div>
            </div>
          </div>
